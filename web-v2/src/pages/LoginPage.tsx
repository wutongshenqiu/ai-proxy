    ...
    <div className="auth-screen">
      <div className="auth-card">
        <div className="auth-brand">
          ...
          <div>
            <strong>Prism V2</strong>
            <p>Greenfield control plane</p>
          </div>
        </div>
        ...
        <div className="auth-hero">
          ...
          <p className="auth-copy">
            Cookie-backed dashboard auth gates the greenfield shell. The old console stays live until cutover, but this shell now has its own real sign-in flow.
          </p>
