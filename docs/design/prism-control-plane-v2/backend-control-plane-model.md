# Backend Control-Plane Model for Prism V2
...
This should support a greenfield frontend.
The backend does not need to preserve the legacy page model just because old handlers exist.
...
This lets Prism complete a new frontend in parallel while the old dashboard remains the production UI until cutover.
