...
- `docs/design/prism-control-plane-v2/prototype.html?screen=traffic-lab`
- `docs/design/prism-control-plane-v2/debug-config-deep-dive.md`
- `docs/design/prism-control-plane-v2/extensibility-model.md`
