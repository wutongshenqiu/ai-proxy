# Prism Control Plane V2 with Pencil Dev
...
- [../cutover-scope-review.md](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/cutover-scope-review.md)
...
- [CONVENTIONS.md](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/pencil-dev/CONVENTIONS.md)
- [ARCHITECTURE.md](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/pencil-dev/ARCHITECTURE.md)
- [QUALITY-GATES.md](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/pencil-dev/QUALITY-GATES.md)
- [workspaces/README.md](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/pencil-dev/workspaces/README.md)
...
- [output/pencil/prism-control-plane-v2](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2)

Key review artifacts now include:

- [foundations-overview--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/foundations-overview--latest.png)
- [platform-patterns-overview--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/platform-patterns-overview--latest.png)
- [entity-editors-overview--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/entity-editors-overview--latest.png)
- [command-center-overview--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/command-center-overview--latest.png)
- [traffic-lab-overview--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/traffic-lab-overview--latest.png)
- [provider-atlas-overview--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/provider-atlas-overview--latest.png)
- [route-studio-overview--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/route-studio-overview--latest.png)
- [change-studio-overview--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/change-studio-overview--latest.png)
...
5. Create or save the first design file into:
   ...
   `docs/design/prism-control-plane-v2/pencil-dev/workspaces/prism-control-plane-traffic-lab.pen`
...
```text
docs/design/prism-control-plane-v2/
├── prototype.html
├── prototype.css
├── prototype.js
└── pencil-dev/
...
- `output/pencil/prism-control-plane-v2/`

See [CONVENTIONS.md](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/pencil-dev/CONVENTIONS.md) for naming and revision policy, and [ARCHITECTURE.md](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/pencil-dev/ARCHITECTURE.md) for the reusable workspace layering model.
...
Use [QUALITY-GATES.md](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/pencil-dev/QUALITY-GATES.md) as the mandatory acceptance bar before refreshing any `--latest` PNG.
...
- [foundations-overview--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/foundations-overview--latest.png)
- [command-center-overview--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/command-center-overview--latest.png)
- [command-center-signal-queue--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/command-center-signal-queue--latest.png)
- [command-center-side-stack--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/command-center-side-stack--latest.png)
- [command-center-inspector--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/command-center-inspector--latest.png)
- [shell-kit-overview--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/shell-kit-overview--latest.png)
- [traffic-lab-overview--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/traffic-lab-overview--latest.png)
- [traffic-lab-sessions-panel--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/traffic-lab-sessions-panel--latest.png)
- [traffic-lab-trace-panel--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/traffic-lab-trace-panel--latest.png)
- [traffic-lab-inspector--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/traffic-lab-inspector--latest.png)
- [change-studio-overview--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/change-studio-overview--latest.png)
- [change-studio-registry--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/change-studio-registry--latest.png)
- [change-studio-workbench--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/change-studio-workbench--latest.png)
- [change-studio-watch-window--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/change-studio-watch-window--latest.png)
- [change-studio-inspector--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/change-studio-inspector--latest.png)
- [route-studio-overview--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/route-studio-overview--latest.png)
- [route-studio-workbench--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/route-studio-workbench--latest.png)
- [route-studio-scenario-matrix--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/route-studio-scenario-matrix--latest.png)
- [route-studio-inspector--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/route-studio-inspector--latest.png)
- [provider-atlas-overview--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/provider-atlas-overview--latest.png)
- [provider-atlas-workbench--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/provider-atlas-workbench--latest.png)
- [provider-atlas-coverage-matrix--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/provider-atlas-coverage-matrix--latest.png)
- [provider-atlas-inspector--latest.png](/Users/qiufeng/work/proxy/prism/output/pencil/prism-control-plane-v2/provider-atlas-inspector--latest.png)
