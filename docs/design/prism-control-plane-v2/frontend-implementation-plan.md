# Frontend Implementation Plan for Prism Control Plane V2
...
- [README.md](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/README.md)
...
- build the new shell in `web-v2/`
- keep legacy production UI in `web/` until the V2 pack is complete

## Greenfield Stance

The frontend should be treated as a greenfield control-plane implementation.
...
- product model: greenfield
- shell and interaction model: greenfield
