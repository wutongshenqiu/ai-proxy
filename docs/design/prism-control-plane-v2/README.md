# Prism Control Plane V2 Prototype
...
- `debug-config-reference.md` - source-map view of current debug/config power and how V2 should absorb it
...
- [debug-config-deep-dive.md](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/debug-config-deep-dive.md)
- [debug-config-reference.md](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/debug-config-reference.md)
...
- [pencil-dev/README.md](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/pencil-dev/README.md)
- [pencil-dev/CONVENTIONS.md](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/pencil-dev/CONVENTIONS.md)
- [pencil-dev/ARCHITECTURE.md](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/pencil-dev/ARCHITECTURE.md)

## Review Flow

Open [prototype.html](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/prototype.html) in a browser, or serve this folder locally and inspect the prototype there.

Useful deep links while reviewing:

- [prototype.html?screen=traffic-lab](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/prototype.html?screen=traffic-lab)
- [prototype.html?screen=change-studio](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane-v2/prototype.html?screen=change-studio)
