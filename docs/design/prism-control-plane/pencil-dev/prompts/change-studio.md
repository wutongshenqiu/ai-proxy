...
- the final screen must satisfy [QUALITY-GATES.md](/Users/qiufeng/work/proxy/prism/docs/design/prism-control-plane/pencil-dev/QUALITY-GATES.md)

Reference files:

- `docs/design/prism-control-plane/prototype.html?screen=change-studio`
- `docs/design/prism-control-plane/config-crud-model.md`
- `docs/design/prism-control-plane/north-star-model.md`
